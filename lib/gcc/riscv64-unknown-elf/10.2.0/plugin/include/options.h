...
#define MASK_XTHEAD (1U << 15)
#define MASK_XTHEAD_C (1U << 16)
#define MASK_XTHEAD_E (1U << 17)
#define MASK_XTHEAD_SE (1U << 18)
#define MASK_ZPN (1U << 19)
#define MASK_ZPRVSFEXTRA (1U << 20)
#define MASK_ZPSFOPERAND (1U << 21)
...
enum opt_code
{
  ...
  OPT_mdelete_vsetvl = 1612,                 /* -mdelete-vsetvl */
  OPT_mdelete_vsetvl_globally = 1613,        /* -mdelete-vsetvl-globally */
  OPT_mdelete_vsetvl_zero = 1614,            /* -mdelete-vsetvl-zero */
  OPT_mdelete_vsetvl_zero_bbs = 1615,        /* -mdelete-vsetvl-zero-bbs */
  OPT_mdelete_vsetvl2 = 1616,                /* -mdelete-vsetvl2 */
  OPT_mdiv = 1617,                           /* -mdiv */
  OPT_mdup_loop_header = 1618,               /* -mdup-loop-header */
  OPT_mexpand_split_imm = 1619,              /* -mexpand-split-imm */
  OPT_mexplicit_relocs = 1620,               /* -mexplicit-relocs */
  OPT_mext = 1621,                           /* -mext */
  OPT_mfclass = 1622,                        /* -mfclass */
  OPT_mfdiv = 1623,                          /* -mfdiv */
  OPT_mfldr = 1624,                          /* -mfldr */
  OPT_mfmvhw32 = 1625,                       /* -mfmvhw32 */
  OPT_mfp16 = 1626,                          /* -mfp16 */
  OPT_minvariant_as_constant = 1627,         /* -minvariant-as-constant */
  OPT_mipa_unhot_inline = 1628,              /* -mipa-unhot-inline */
  OPT_mipush = 1629,                         /* -mipush */
  OPT_misa_spec_ = 1630,                     /* -misa-spec= */
  OPT_miv_adjust_addr_cost = 1631,           /* -miv-adjust-addr-cost */
  OPT_mldd = 1632,                           /* -mldd */
  OPT_mldi = 1633,                           /* -mldi */
  OPT_mldr = 1634,                           /* -mldr */
  OPT_mmove_loop_vsetvl = 1635,              /* -mmove-loop-vsetvl */
  OPT_mmula = 1636,                          /* -mmula */
  OPT_mplt = 1637,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1638,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1639,                         /* -mrelax */
  OPT_mrev = 1640,                           /* -mrev */
  OPT_mrevw = 1641,                          /* -mrevw */
  OPT_mriscv_attribute = 1642,               /* -mriscv-attribute */
  OPT_mrnreg_delete_noop_move = 1643,        /* -mrnreg-delete-noop-move */
  OPT_mrvv_vector_bits_ = 1644,              /* -mrvv-vector-bits= */
  OPT_msave_restore = 1645,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1646,               /* -mshorten-memrefs */
  OPT_msignedness_cmpiv = 1647,              /* -msignedness-cmpiv */
  OPT_msmall_data_limit_ = 1648,             /* -msmall-data-limit= */
  OPT_msrri = 1649,                          /* -msrri */
  OPT_msrriw = 1650,                         /* -msrriw */
  OPT_mstrict_align = 1651,                  /* -mstrict-align */
  OPT_mthread_jumps1 = 1652,                 /* -mthread-jumps1 */
  OPT_mtune_ = 1653,                         /* -mtune= */
  OPT_mxor_combine = 1654,                   /* -mxor-combine */
  OPT_n = 1655,                              /* -n */
  ...
  OPT_pie = 1675,                            /* -pie */
  OPT_pipe = 1676,                           /* -pipe */
  OPT_print_file_name_ = 1677,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1678,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1679,          /* -print-multi-directory */
  OPT_print_multi_lib = 1680,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1681,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1682,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1683,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1684,               /* -print-prog-name= */
  OPT_print_search_dirs = 1685,              /* -print-search-dirs */
  OPT_print_sysroot = 1686,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1687,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1688,                    /* -print-value */
  OPT_quiet = 1689,                          /* -quiet */
  OPT_r = 1690,                              /* -r */
  OPT_remap = 1691,                          /* -remap */
  OPT_reverse_sort = 1692,                   /* -reverse-sort */
  OPT_s = 1693,                              /* -s */
  OPT_save_temps = 1694,                     /* -save-temps */
  OPT_save_temps_ = 1695,                    /* -save-temps= */
  OPT_shared = 1696,                         /* -shared */
  OPT_shared_libgcc = 1697,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1698,               /* -shared-libphobos */
  OPT_size_sort = 1699,                      /* -size-sort */
  /* OPT_specs = 1700, */                    /* -specs */
  OPT_specs_ = 1701,                         /* -specs= */
  OPT_static = 1702,                         /* -static */
  OPT_static_libasan = 1703,                 /* -static-libasan */
  OPT_static_libgcc = 1704,                  /* -static-libgcc */
  OPT_static_libgfortran = 1705,             /* -static-libgfortran */
  OPT_static_libgo = 1706,                   /* -static-libgo */
  OPT_static_liblsan = 1707,                 /* -static-liblsan */
  OPT_static_libmpx = 1708,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1709,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1710,               /* -static-libphobos */
  OPT_static_libstdc__ = 1711,               /* -static-libstdc++ */
  OPT_static_libtsan = 1712,                 /* -static-libtsan */
  OPT_static_libubsan = 1713,                /* -static-libubsan */
  OPT_static_pie = 1714,                     /* -static-pie */
  /* OPT_std_c__03 = 1715, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1716, */                /* -std=c++0x */
  OPT_std_c__11 = 1717,                      /* -std=c++11 */
  OPT_std_c__14 = 1718,                      /* -std=c++14 */
  OPT_std_c__17 = 1719,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1720, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1721, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1722, */                /* -std=c++20 */
  OPT_std_c__2a = 1723,                      /* -std=c++2a */
  OPT_std_c__98 = 1724,                      /* -std=c++98 */
  OPT_std_c11 = 1725,                        /* -std=c11 */
  OPT_std_c17 = 1726,                        /* -std=c17 */
  /* OPT_std_c18 = 1727, */                  /* -std=c18 */
  /* OPT_std_c1x = 1728, */                  /* -std=c1x */
  OPT_std_c2x = 1729,                        /* -std=c2x */
  /* OPT_std_c89 = 1730, */                  /* -std=c89 */
  OPT_std_c90 = 1731,                        /* -std=c90 */
  OPT_std_c99 = 1732,                        /* -std=c99 */
  /* OPT_std_c9x = 1733, */                  /* -std=c9x */
  OPT_std_f2003 = 1734,                      /* -std=f2003 */
  OPT_std_f2008 = 1735,                      /* -std=f2008 */
  OPT_std_f2008ts = 1736,                    /* -std=f2008ts */
  OPT_std_f2018 = 1737,                      /* -std=f2018 */
  OPT_std_f95 = 1738,                        /* -std=f95 */
  OPT_std_gnu = 1739,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1740, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1741, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1742,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1743,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1744,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1745, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1746, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1747, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1748,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1749,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1750,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1751,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1752, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1753, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1754,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1755, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1756,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1757,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1758, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1759, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1760,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1761, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1762, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1763, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1764, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1765, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1766,                     /* -std=legacy */
  OPT_symbol_ = 1767,                        /* -symbol= */
  OPT_symbolic = 1768,                       /* -symbolic */
  OPT_t = 1769,                              /* -t */
  OPT_time = 1770,                           /* -time */
  OPT_time_ = 1771,                          /* -time= */
  OPT_traditional = 1772,                    /* -traditional */
  OPT_traditional_cpp = 1773,                /* -traditional-cpp */
  OPT_tree_stats = 1774,                     /* -tree-stats */
  OPT_trigraphs = 1775,                      /* -trigraphs */
  OPT_type_stats = 1776,                     /* -type-stats */
  OPT_u = 1777,                              /* -u */
  OPT_undef = 1778,                          /* -undef */
  OPT_v = 1779,                              /* -v */
  OPT_version = 1780,                        /* -version */
  OPT_w = 1781,                              /* -w */
  OPT_wrapper = 1782,                        /* -wrapper */
  OPT_x = 1783,                              /* -x */
  OPT_z = 1784,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
